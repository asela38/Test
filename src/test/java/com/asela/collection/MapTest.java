...
public class MapTest {
    ...
    public void wowByGroupBy() throws Exception {
        ...
        Map<RH, Map<BloodGroup, Sample>> collect = samples.stream().collect(Collectors.groupingBy(Sample::getRh,
                Collectors.toMap(Sample::getGroup, Function.identity(), (a, b) -> b)));
